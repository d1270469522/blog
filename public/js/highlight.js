...
var hljs = function() {
    ...
    const d = "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)", h = {
      begin: "\\\\[\\s\\S]",
      relevance: 0
    }, f = {
      className: "string",
    ...
    const y = {
      ...
      computed: {
        className() {
          ...
          if (!this.autoDetect && !hljs.getLanguage(this.language)) return console.warn(`The language "${this.language}"
          you specified could not be found.`), this.unknownLanguage = !0, t(this.code);
          let e;
    ...
    return function(t) {
      ...
      function b(e, t, a, s) {
        ...
        function h(e) {
          return e.className && M.openNode(e.className), R = Object.create(e, {
            parent: {
              value: R
            }
          })
        ...
        var _ = function(e) {
            ...
            class t {
              ...
              addRule(e, n) {
                n.position = this.position++, this.matchIndexes[this.matchAt] = n, this.regexes.push([n, e]), this.matchAt +=
                function(e) {
      ...
      Object.assign(t, {
        ...
        registerLanguage: function(e, n) {
          ...
          r.name || (r.name = e), i[e] = r, r.rawDefinition = n.bind(null, t), r.aliases && j(r.aliases, {
            languageName: e
          })
        },
...
hljs.registerLanguage("php", function() {
  ...
  return function(e) {
    var r = {
      ...
      c = {
        keyword: "__CLASS__ __DIR__ __FILE__ __FUNCTION__ __LINE__ __METHOD__ __NAMESPACE__ __TRAIT__ die echo exit include include_once print require require_once array abstract and as binary bool boolean break callable case catch class clone const continue declare default do double else elseif empty enddeclare endfor endforeach endif endswitch endwhile eval extends final finally float for foreach from global goto if implements instanceof insteadof int integer interface isset iterable list new object or private protected public real return string switch throw trait try unset use var void while xor yield json_encode json_decode base64_encode",
